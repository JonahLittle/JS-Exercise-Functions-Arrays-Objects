 ...
 * }
*/
function makePersonObject(idValue, nameValue, emailValue) {
  return {
  id: idValue,
  name: nameValue,
  email: emailValue
...
function makeSmartPerson(nameInput) {
  return {name: nameInput, sum: function(num1, num2){
    return num1 + num2},speak: function(){
